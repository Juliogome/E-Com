...
if page == pages[3]:
    ...
    st.write("The results of all three models are very good at predicting which customers are most likely to complete a "
         ...
         "Further optimization is not necessary due to the very good results. For this reason, this is not done here, "
         "and only the importance of the variables will be showcased in 4.3. Interpretation of results which can be used "
